...
/datum/weather/rad_storm
	...
	weather_message = "<span class='userdanger'>The air begins to grow warm, and an old world alarm plays in the distance.</span>"
	weather_overlay = "ash_storm"
	weather_duration_lower = 600
	weather_duration_upper = 1500
	weather_color = "green"
	weather_sound = 'sound/f13effects/alarm.ogg'
