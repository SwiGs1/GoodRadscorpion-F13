...
#define THIRST_LEVEL_TURGID 450
#define THIRST_LEVEL_HYDRATED 400
#define THIRST_LEVEL_LIGHT 200
#define THIRST_LEVEL_MIDDLE 150
...
#define THIRST_LEVEL_START_MIN 300
#define THIRST_LEVEL_START_MAX 415
...
#define THIRST_FACTOR		0.3 // factor at which mob thrist decreases
...
//Respawn timer
#define RESPAWN_TIMER 3900 // in deciseconds, the time to wait before allowing respawn. 15 minutes = 15 * 60 (seconds in minute) * 15 (seconds to deciseconds)
