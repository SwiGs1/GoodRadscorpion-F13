...
#define THIRST_LEVEL_LIGHT 350
#define THIRST_LEVEL_MIDDLE 250
...
#define THIRST_LEVEL_START_MAX 380
...
#define THIRST_FACTOR		0.4 // factor at which mob thrist decreases
