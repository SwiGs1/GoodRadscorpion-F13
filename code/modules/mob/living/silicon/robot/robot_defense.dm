		...
		if(!(lying))
			...
			if(I)
				...
				visible_message("<span class='danger'>[M] disarmed [src]!</span>", \
					"<span class='boldannounce'>[M] has disabled [src]'s active module!</span>", null, COMBAT_MESSAGE_RANGE)
				...
				visible_message("<span class='danger'>[M] has forced back [src]!</span>", \
					"<span class='boldannounce'>[M] has forced back [src]!</span>", null, COMBAT_MESSAGE_RANGE)
